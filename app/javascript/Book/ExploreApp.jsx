...
const GenreName = ({ genre_name, genre_counts, requireGenre, removeGenre }) => {
	return <div>
				{genre_name} <span className="text-secondary">({genre_counts[genre_name]})</span>
				<span onClick={() => requireGenre(genre_name)} className="px-1">+</span>
				<span onClick={() => removeGenre(genre_name)} className="px-1">-</span>
			</div>
}
